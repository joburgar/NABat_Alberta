...
```{r TerraSolis pdf map, out.width="0.3\\linewidth", include=TRUE, fig.align="center", fig.cap=c("Bat Survey Locations 2015-2020"), echo=FALSE}
...
```{r sp hist, echo=F, fig.width=6.5, fig.cap="Overall bat call counts for species / species groups by year"}
...
Sp.hist <- ggplot(data = Sp.hist.data, aes(x = Classification, y = n, fill= Deployment.ID)) + 
  geom_bar(stat = "identity") + 
  scale_fill_manual(values=col.catYr)+
...
for (i in 1:length(call_year)) {
  ...
  print(knitr::kable(df.year, 
             caption = paste("Mean ± 1 SE nightly bat calls for each NABat GRTS quadrant (SE = South-east, SW = South-west, NE = North-east, and NW = North-west) in ",year,". # Nights refers to the number of nights the quadrant was surveyed.", sep=""), 
             digits=1))
  cat('\n\n')
  options(opts)
}
...
##### Table 3.Mean ± 1 SE nightly bat calls for each NABat GRTS quadrant (SE = South-east, SW = South-west, NE = North-east, and NW = North-west) in 2016. # Nights refers to the number of nights the quadrant was surveyed.
``` {r 2016 mean nightly call by GRTS quadrant, echo=F, warning=FALSE}

opts <- options(knitr.kable.NA = "")
knitr::kable(mean.se.quad.count2016, booktabs=TRUE, digits=1)
options(opts)

```

##### Table 4.Mean ± 1 SE nightly bat calls for each NABat GRTS quadrant (SE = South-east, SW = South-west, NE = North-east, and NW = North-west) in 2017. # Nights refers to the number of nights the quadrant was surveyed.
``` {r 2017 mean nightly call by GRTS quadrant, echo=F, warning=FALSE}

opts <- options(knitr.kable.NA = "")
knitr::kable(mean.se.quad.count2017, booktabs=TRUE, digits=1)
options(opts)

```

##### Table 5.Mean ± 1 SE nightly bat calls for each NABat GRTS quadrant (SE = South-east, SW = South-west, NE = North-east, and NW = North-west) in 2018. # Nights refers to the number of nights the quadrant was surveyed.
``` {r 2018 mean nightly call by GRTS quadrant, echo=F, warning=FALSE}

opts <- options(knitr.kable.NA = "")
knitr::kable(mean.se.quad.count2018, booktabs=TRUE, digits=1)
options(opts)

```

##### Table 6.Mean ± 1 SE nightly bat calls for each NABat GRTS quadrant (SE = South-east, SW = South-west, NE = North-east, and NW = North-west) in 2019. # Nights refers to the number of nights the quadrant was surveyed.
``` {r 2019 mean nightly call by GRTS quadrant, echo=F, warning=FALSE}

opts <- options(knitr.kable.NA = "")
knitr::kable(mean.se.quad.count2019, booktabs=TRUE, digits=1)
options(opts)

```

##### Table 6.Mean ± 1 SE nightly bat calls for each NABat GRTS quadrant (SE = South-east, SW = South-west, NE = North-east, and NW = North-west) in 2020. # Nights refers to the number of nights the quadrant was surveyed.
``` {r 2020 mean nightly call by GRTS quadrant, echo=F, warning=FALSE}

opts <- options(knitr.kable.NA = "")
knitr::kable(mean.se.quad.count2020, booktabs=TRUE, digits=1)
options(opts)
