...
#Load Packages
list.of.packages <- c("leaflet", "tidyverse", "lunar", "zoo", "colortools", "mapview", "data.table", "fs", "lubridate", "camtrapR")
...
###--- create land.use.type covariate
...
There were `r sprintf("%.0f", sum(call_count$Count))` bat calls recorded at `r n.stat` bat survey locations between `r min(eff$Deployment.ID)` and `r max(eff$Deployment.ID)`. Of these calls, `r round(unknown.calls*100,0)`% were classified as unknown.
...
dat_time %>% count(Classification_Volancy)

dat_timeVol <- dat_time %>% pivot_wider(names_from = c("Volancy"),  values_from = c("Classification"))
...
activityOverlap(recordTable = dat_time,#[dat_time$Volancy=="Pre-volancy",],
                                 speciesA = "In",
                                 speciesB = "Out",
                                 speciesCol = "NP",
                                 ...
                                 extend      = "lightgrey",
                                 ylim = c(0,0.25),
                                 main = "Overall bat activity overlap in/out of National Parks")
...
volancy.overlap <- volancy_overlap.fn(Classification=class.list[8,])
```

```{r NP activity overlap, out.width="33%", out.height="20%",fig.show='hold', fig.align='center', echo=FALSE}

knitr::include_graphics(c("./Output/activity_overlap_In-Out_2021-01-27.png",
                          "./Output/activity_overlap_In-Out_pre_2021-01-27.png",
                          "./Output/activity_overlap_In-Out_post_2021-01-27.png"))
``` 
...
knitr::include_graphics(c("./Output/activity_overlap_EPFU Pre-volancy-EPFU Post-volancy_2021-01-27.png",
                          "./Output/activity_overlap_EPFU-LANO Pre-volancy-EPFU-LANO Post-volancy_2021-01-27.png",
                          "./Output/activity_overlap_LANO Pre-volancy-LANO Post-volancy_2021-01-27.png"))
``` 
...
knitr::include_graphics(c("./Output/activity_overlap_LABO Pre-volancy-LABO Post-volancy_2021-01-27.png",
                          "./Output/activity_overlap_LABO-MYLU Pre-volancy-LABO-MYLU Post-volancy_2021-01-27.png",
                          "./Output/activity_overlap_MYLU Pre-volancy-MYLU Post-volancy_2021-01-27.png"))
``` 
...
knitr::include_graphics(c("./Output/activity_overlap_LACI Pre-volancy-LACI Post-volancy_2021-01-27.png",
                          "./Output/activity_overlap_Myotis 40k Pre-volancy-Myotis 40k Post-volancy_2021-01-27.png"))
``` 
