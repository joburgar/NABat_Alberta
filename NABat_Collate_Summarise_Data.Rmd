...
GRTS.Calls.Yr <- call_count2 %>% group_by(NP, Land.Unit.Code, Deployment.ID, GRTS.Cell.ID) %>% summarise(Mean = mean(Count), SE = se(Count))
...
##### Figure 11. Mean nightly bat calls for each NABat grid cell by year.
